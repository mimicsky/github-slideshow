...
A living record of everything in stock — proteins, produce, pantry goods,
seasonings, sauces, dairy, and the bar. Kept up to date from your phone.
This is the source of truth used to suggest specials, new menu items, and
seasoning blends based only on what's actually on hand.

**How this gets used:**
1. You tell me what's in stock (add, remove, or update quantities) and I keep
   this file current.
2. When you want ideas for a special, new dish, or a seasoning blend, I read
   this file and suggest options built only from what's listed here.
...
| Broccoli | | In stock |
| Carrots | shredded | In stock |
| Carrots | whole | In stock |
| Carrots | sliced | In stock |
| Peppers | | In stock |
| Mushrooms | | In stock |
| White onions | | In stock |
| Red onions | | In stock |
| Zucchini | | In stock |
| Potatoes | | In stock |
| Red potatoes | | In stock |
| Artichoke hearts | | In stock |
| Cucumber | | In stock |
| Tomato | | In stock |
| Oranges | | In stock |
| Green apples | | In stock |
| Limes | | In stock |
| Lemons | | In stock |
| Parsley | | In stock |
| Celery | | In stock |
...
| Blue cheese crumbles | | In stock |

## Pantry / Dry Goods

| Item | Notes | Stock |
|---|---|---|
| Seasoned rice | | In stock |
| Linguine | pasta | In stock |
| Ravioli | | In stock |
| Flour | | In stock |
| Corn starch | | In stock |
| Baking soda | | In stock |
| Pecans | | In stock |
| Flat bread | | In stock |
| Croutons | | In stock |
...
| Mojo criollo | | In stock |
| Soy sauce | | In stock |
| Honey | | In stock |
| Balsamic | vinegar | In stock |
| Blue cheese dressing | | In stock |
| Thousand island dressing | | In stock |
| Honey mustard | | In stock |
| Chicken base | | In stock |

## Seasonings, Spices & Herbs

| Name | Flavor Profile | Heat | Pairs Well With | Stock |
|---|---|---|---|---|
| Rosemary leaves | | | | In stock |
| Basil | | | | In stock |
| Bay leaves | | | | In stock |
| Kosher salt | | | | In stock |
...
| Tajín | Store bought | Chile peppers, sea salt, citric acid, dehydrated lime juice, silicon dioxide (anti-caking) | In stock |
...
Ideas generated from current stock, so you can track what's been tried.

```
### Dish Name
- **Date:**
- **Ingredients used (from stock):**
- **Description:**
- **Result / feedback:**
```
